...
CHUNKS_EMBEDDED = Counter(
    "vec_stream_chunks_embedded_total", "Chunks embedded (the expensive call)"
)
DLQ_SENT = Counter("vec_stream_dlq_sent_total", "Messages sent to DLQ")
SYNC_DELAY = Histogram(
    "vec_stream_sync_delay_seconds",
